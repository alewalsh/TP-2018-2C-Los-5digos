...
enum codigoID {
	...
	SAFA_CPU_BLOQUEO_WAIT,// = 1013,
	SAFA_CPU_INICIO_WAIT,// = 1014,

    //DAM-FM9
    DAM_FM9_CONNECT,// = 1015,
    DAM_FM9_OK,// = 1016,
    DAM_FM9_FAIL,// = 1017,
    DAM_FM9_DISCONNECT,// = 1018,
	DAM_FM9_GUARDARLINEA,// = 1019,
	DAM_FM9_CARGAR_ESCRIPTORIO,// = 1020,
	DAM_FM9_ENVIO_PKG,// = 1021,
	DAM_FM9_FLUSH,// = 1022,
	DAM_FM9_FIN_GDT,// = 1023,

	//DAM-MDJ
	DAM_MDJ_CONNECT,// = 1024,
	DAM_MDJ_OK,// = 1025,
	DAM_MDJ_FAIL,// = 1026,
	DAM_MDJ_DISCONNECT,// = 1027,
	DAM_MDJ_TRANSFER_SIZE,// = 1028,
	DAM_MDJ_CONFIRMAR_EXISTENCIA_ARCHIVO,// = 1029,
	DAM_MDJ_CARGAR_ESCRIPTORIO,// = 1030,
	DAM_MDJ_HACER_FLUSH,// = 1031,
	DAM_MDJ_GUARDAR_DATOS,// = 1032,
	DAM_MDJ_CREAR_ARCHIVO,// = 1033,
	DAM_MDJ_BORRAR_ARCHIVO,// = 1034,
	DAM_MDJ_CONFIRMACION_ENVIO_DEL_MDJ,// = 1035
	DAM_MDJ_CONFIRMACION_ENVIO_DEL_DMA,// = 1036

	//DAM-SAFA
	DAM_SAFA_CONNECT,// = 1037,
	DAM_SAFA_OK,// = 1038,
	DAM_SAFA_FAIL,// = 1039,
	DAM_SAFA_DISCONNECT,// = 1040,
	DAM_SAFA_CONFIRMACION_PID_CARGADO,// = 1041,
	DAM_SAFA_CONFIRMACION_SCRIPT_INICIALIZADO,// = 1042,
	DAM_SAFA_CONFIRMACION_DATOS_GUARDADOS,// = 1043,
	DAM_SAFA_CONFIRMACION_CREAR_ARCHIVO,// = 1044,
	DAM_SAFA_CONFIRMACION_BORRAR_ARCHIVO,// = 1045,

	//CPU-FM9
	CPU_FM9_CONNECT,// = 1046,
	CPU_FM9_OK,// = 1047,
	CPU_FM9_FAIL,// = 1048,
	CPU_FM9_DISCONNECT,// = 1049,
	CPU_FM9_CERRAR_ARCHIVO,// = 1050,
	CPU_FM9_ASIGNAR,// = 1051,
	CPU_FM9_CARGAR_ESCRIPTORIO,// = 1052,
	CPU_FM9_FIN_GDT,// = 1053,
	CPU_FM9_DAME_INSTRUCCION,// = 1054

	//CPU-DAM
	CPU_DAM_CONNECT,// = 1055,
	CPU_DAM_OK,// = 1056,
	CPU_DAM_FAIL,// = 1057,
	CPU_DAM_DISCONNECT,// = 1058,
	CPU_DAM_BUSQUEDA_ESCRIPTORIO,// = 1059,
	CPU_DAM_ABRIR_ARCHIVO,// = 1060,
	CPU_DAM_FLUSH,// = 1061,
	CPU_DAM_CREAR,// = 1062,
	CPU_DAM_BORRAR,// = 1063,

	//CPU-SAFA
	CPU_SAFA_CONNECT,// = 1064,
	CPU_SAFA_OK,// = 1065,
	CPU_SAFA_FAIL,// = 1066,
	CPU_SAFA_DISCONNECT,// = 1067,
	CPU_SAFA_BLOQUEAR_DUMMMY,// = 1068,
	CPU_SAFA_WAIT_RECURSO,// = 1069,
	CPU_SAFA_SIGNAL_RECURSO,// = 1070,
	CPU_SAFA_BLOQUEAR_DTB,// = 1071,
	CPU_SAFA_ABORTAR_DTB,// = 1072,
	CPU_SAFA_ABORTAR_DTB_NUEVO,// = 1073,
	CPU_SAFA_FIN_EJECUCION_DTB,// = 1074,
	CPU_SAFA_FIN_EJECUCION_X_QUANTUM_DTB,// = 1075

	//FM9-CPU
	FM9_CPU_CONNECT,// = 1076,
	FM9_CPU_OK,// = 1077,
	FM9_CPU_FAIL,// = 1078,
	FM9_CPU_DISCONNECT,// = 1079,
	FM9_CPU_ACCESO_INVALIDO,// = 1080,
	FM9_CPU_ERROR,// = 1081,
	FM9_CPU_MEMORIA_INSUFICIENTE,// = 1082,
	FM9_CPU_FALLO_SEGMENTO_MEMORIA,// = 1083,
	FM9_CPU_PROCESO_INEXISTENTE,// = 1084,
	FM9_CPU_LINEA_GUARDADA,// = 1085,
	FM9_CPU_ERROR_LINEA_GUARDADA,// = 1086,
	FM9_CPU_ARCHIVO_CERRADO,// = 1087,
	FM9_CPU_GDT_FINALIZADO,// = 1088
	FM9_CPU_DEVUELVO_LINEA,// = 1089,

	//FM9-DAM
	FM9_DAM_MEMORIA_INSUFICIENTE,// = 1090
	FM9_DAM_MEMORIA_INSUFICIENTE_FRAG_EXTERNA,// = 1091,
	FM9_DAM_ARCHIVO_INEXISTENTE,// = 1092,
	FM9_DAM_PROCESO_INEXISTENTE,// = 1093,
	FM9_DAM_ERROR_PAQUETES,// = 1094,
	FM9_DAM_ESCRIPTORIO_CARGADO,// = 1095,
	FM9_DAM_HAY_MEMORIA,// = 1096,
	FM9_DAM_ERROR_CARGA_ESCRIPTORIO,// = 1097,
	FM9_DAM_FLUSH,// = 1098,
	FM9_DAM_ERROR_FLUSH,// = 1099,

    GENERIC_ERROR,// = 1100,

    SOCKET_DISCONECT,// = 1101
    PING,//=1102
    PING_OK//1103
