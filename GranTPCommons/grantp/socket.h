...
enum codigoID {
	...
	DAM_FM9_FLUSH,// = 1020,
	DAM_FM9_FIN_GDT,// = 1021,

	//DAM-MDJ
	DAM_MDJ_CONNECT,// = 1022,
	DAM_MDJ_OK,// = 1023,
	DAM_MDJ_FAIL,// = 1024,
	DAM_MDJ_DISCONNECT,// = 1025,
	DAM_MDJ_TRANSFER_SIZE,// = 1026,
	DAM_MDJ_CONFIRMAR_EXISTENCIA_ARCHIVO,// = 1027,
	DAM_MDJ_CARGAR_ESCRIPTORIO,// = 1028,
	DAM_MDJ_HACER_FLUSH,// = 1029,
	DAM_MDJ_GUARDAR_DATOS,// = 1030,
	DAM_MDJ_CREAR_ARCHIVO,// = 1031,
	DAM_MDJ_BORRAR_ARCHIVO,// = 1032,
	DAM_MDJ_CONFIRMACION_ENVIO_DEL_MDJ,// = 1033
	DAM_MDJ_CONFIRMACION_ENVIO_DEL_DMA,// = 1034

	//DAM-SAFA
	DAM_SAFA_CONNECT,// = 1035,
	DAM_SAFA_OK,// = 1036,
	DAM_SAFA_FAIL,// = 1037,
	DAM_SAFA_DISCONNECT,// = 1035,
	DAM_SAFA_CONFIRMACION_PID_CARGADO,// = 1039,
	DAM_SAFA_CONFIRMACION_SCRIPT_INICIALIZADO,// = 1040,
	DAM_SAFA_CONFIRMACION_DATOS_GUARDADOS,// = 1041,
	DAM_SAFA_CONFIRMACION_CREAR_ARCHIVO,// = 1042,
	DAM_SAFA_CONFIRMACION_BORRAR_ARCHIVO,// = 1043,

	//CPU-FM9
	CPU_FM9_CONNECT,// = 1044,
	CPU_FM9_OK,// = 1045,
	CPU_FM9_FAIL,// = 1046,
	CPU_FM9_DISCONNECT,// = 1047,
	CPU_FM9_CERRAR_ARCHIVO,// = 1048,
	CPU_FM9_ASIGNAR,// = 1049,
	CPU_FM9_CARGAR_ESCRIPTORIO,// = 1050,
	CPU_FM9_FIN_GDT,// = 1051,
	CPU_FM9_DAME_INSTRUCCION,// = 1052

	//CPU-DAM
	CPU_DAM_CONNECT,// = 1053,
	CPU_DAM_OK,// = 1054,
	CPU_DAM_FAIL,// = 1055,
	CPU_DAM_DISCONNECT,// = 1056,
	CPU_DAM_BUSQUEDA_ESCRIPTORIO,// = 1057,
	CPU_DAM_ABRIR_ARCHIVO,// = 1058,
	CPU_DAM_FLUSH,// = 1059,
	CPU_DAM_CREAR,// = 1060,
	CPU_DAM_BORRAR,// = 1061,

	//CPU-SAFA
	CPU_SAFA_CONNECT,// = 1062,
	CPU_SAFA_OK,// = 1063,
	CPU_SAFA_FAIL,// = 1064,
	CPU_SAFA_DISCONNECT,// = 1065,
	CPU_SAFA_BLOQUEAR_DUMMMY,// = 1066,
	CPU_SAFA_WAIT_RECURSO,// = 1067,
	CPU_SAFA_SIGNAL_RECURSO,// = 1068,
	CPU_SAFA_BLOQUEAR_DTB,// = 1069,
	CPU_SAFA_ABORTAR_DTB,// = 1070,
	CPU_SAFA_ABORTAR_DTB_NUEVO,// = 1071,
	CPU_SAFA_FIN_EJECUCION_DTB,// = 1072,
	CPU_SAFA_FIN_EJECUCION_X_QUANTUM_DTB,// = 1073

	//FM9-CPU
	FM9_CPU_CONNECT,// = 1074,
	FM9_CPU_OK,// = 1075,
	FM9_CPU_FAIL,// = 1076,
	FM9_CPU_DISCONNECT,// = 1077,
	FM9_CPU_ACCESO_INVALIDO,// = 1078,
	FM9_CPU_ERROR,// = 1079,
	FM9_CPU_MEMORIA_INSUFICIENTE,// = 1080,
	FM9_CPU_FALLO_SEGMENTO_MEMORIA,// = 1081,
	FM9_CPU_PROCESO_INEXISTENTE,// = 1082,
	FM9_CPU_LINEA_GUARDADA,// = 1083,
	FM9_CPU_ERROR_LINEA_GUARDADA,// = 1084,
	FM9_CPU_ARCHIVO_CERRADO,// = 1085,
	FM9_CPU_GDT_FINALIZADO,// = 1086
	FM9_CPU_DEVUELVO_LINEA,// = 1087,

	//FM9-DAM
	FM9_DAM_MEMORIA_INSUFICIENTE,// = 1088,
	FM9_DAM_MEMORIA_INSUFICIENTE_FRAG_EXTERNA,// = 1089,
	FM9_DAM_ARCHIVO_INEXISTENTE,// = 1090,
	FM9_DAM_PROCESO_INEXISTENTE,// = 1091,
	FM9_DAM_ERROR_PAQUETES,// = 1092,
	FM9_DAM_ESCRIPTORIO_CARGADO,// = 1093,
	FM9_DAM_HAY_MEMORIA,// = 1094,
	FM9_DAM_ERROR_CARGA_ESCRIPTORIO,// = 1095,
	FM9_DAM_FLUSH,// = 1096,
	FM9_DAM_ERROR_FLUSH,// = 1097,

    GENERIC_ERROR,// = 1098,

    SOCKET_DISCONECT,// = 1099
    PING,//=1100
    PING_OK//1101
