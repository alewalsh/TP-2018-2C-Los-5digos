...
enum codigoID {
	...
	DAM_MDJ_CONFIRMACION_ENVIO_DEL_MDJ,// =
	DAM_MDJ_CONFIRMACION_ENVIO_DEL_DMA,
	...
	//CPU-SAFA
	CPU_SAFA_CONNECT,// = 1049,
	CPU_SAFA_OK,// = 1050,
	CPU_SAFA_FAIL,// = 1051,
	CPU_SAFA_DISCONNECT,// = 1052,
	...
	//FM9-CPU
	FM9_CPU_CONNECT,// = 1049,
	FM9_CPU_OK,// = 1050,
	FM9_CPU_FAIL,// = 1051,
	FM9_CPU_DISCONNECT,// = 1052,
