...
//	SAFA_CPU_BEGIN_COMPACT,// = 1015,
	...
	SAFA_CPU_EJECUTAR,// = 1012,
	SAFA_CPU_QUANTUM,// = 1013,

    //DAM-FM9
    DAM_FM9_CONNECT,// = 1014,
    DAM_FM9_OK,// = 1015,
    DAM_FM9_FAIL,// = 1016,
    DAM_FM9_DISCONNECT,// = 1017,
	DAM_FM9_GUARDARLINEA,// = 1018,
	DAM_FM9_CARGAR_ESCRIPTORIO,// = 1019,
	DAM_FM9_ENVIO_PKG,// = 1020,
	DAM_FM9_FLUSH,// = 1021,
	...
	//DAM-SAFA
	DAM_SAFA_CONNECT,// = 1033,
	DAM_SAFA_OK,// = 1034,
	DAM_SAFA_FAIL,// = 1035,
	DAM_SAFA_DISCONNECT,// = 1036,
	DAM_SAFA_CONFIRMACION_PID_CARGADO,// = 1037,
